...
public class GitCreds  {
    ...
    **/
    ...
    public GitCreds password(SecretKeySelector password) {
        this.password = password;
        return this;
    }
    ...
    **/
    ...
    public GitCreds username(SecretKeySelector username) {
        this.username = username;
        return this;
    }
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class GitCredsQueryParam  {
        ...
        **/
        ...
        public GitCredsQueryParam password(SecretKeySelector password) {
            this.password = password;
            return this;
        }
        ...
        **/
        ...
        public GitCredsQueryParam username(SecretKeySelector username) {
            this.username = username;
            return this;
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("class GitCredsQueryParam {\n");
