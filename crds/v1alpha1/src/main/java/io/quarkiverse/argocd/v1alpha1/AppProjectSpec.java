...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "clusterResourceBlacklist", "clusterResourceWhitelist", "description",
        "destinations", "namespaceResourceBlacklist", "namespaceResourceWhitelist", "orphanedResources",
        "permitOnlyProjectScopedClusters", "roles", "signatureKeys", "sourceNamespaces", "sourceRepos", "syncWindows" })
...
public class AppProjectSpec implements io.fabric8.kubernetes.api.builder.Editable<AppProjectSpecBuilder>,
    ...
    private java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.ClusterResourceBlacklist> clusterResourceBlacklist;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.ClusterResourceBlacklist> getClusterResourceBlacklist() {
        return clusterResourceBlacklist;
    }

    public void setClusterResourceBlacklist(
            java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.ClusterResourceBlacklist> clusterResourceBlacklist) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.ClusterResourceWhitelist> clusterResourceWhitelist;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.ClusterResourceWhitelist> getClusterResourceWhitelist() {
        return clusterResourceWhitelist;
    }

    public void setClusterResourceWhitelist(
            java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.ClusterResourceWhitelist> clusterResourceWhitelist) {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Description contains optional project description")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.Destinations> destinations;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.Destinations> getDestinations() {
        return destinations;
    }

    public void setDestinations(java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.Destinations> destinations) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.NamespaceResourceBlacklist> namespaceResourceBlacklist;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.NamespaceResourceBlacklist> getNamespaceResourceBlacklist() {
        return namespaceResourceBlacklist;
    }

    public void setNamespaceResourceBlacklist(
            java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.NamespaceResourceBlacklist> namespaceResourceBlacklist) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.NamespaceResourceWhitelist> namespaceResourceWhitelist;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.NamespaceResourceWhitelist> getNamespaceResourceWhitelist() {
        return namespaceResourceWhitelist;
    }

    public void setNamespaceResourceWhitelist(
            java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.NamespaceResourceWhitelist> namespaceResourceWhitelist) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.appprojectspec.OrphanedResources orphanedResources;

    public io.quarkiverse.argocd.v1alpha1.appprojectspec.OrphanedResources getOrphanedResources() {
        return orphanedResources;
    }

    public void setOrphanedResources(io.quarkiverse.argocd.v1alpha1.appprojectspec.OrphanedResources orphanedResources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.Roles> roles;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.Roles> getRoles() {
        return roles;
    }

    public void setRoles(java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.Roles> roles) {
        this.roles = roles;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.SignatureKeys> signatureKeys;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.SignatureKeys> getSignatureKeys() {
        return signatureKeys;
    }

    public void setSignatureKeys(java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.SignatureKeys> signatureKeys) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.SyncWindows> syncWindows;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.SyncWindows> getSyncWindows() {
        return syncWindows;
    }

    public void setSyncWindows(java.util.List<io.quarkiverse.argocd.v1alpha1.appprojectspec.SyncWindows> syncWindows) {
