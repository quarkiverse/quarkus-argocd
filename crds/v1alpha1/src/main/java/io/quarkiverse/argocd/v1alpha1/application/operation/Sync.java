...
public class Sync
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.application.operation.sync.Resources> resources;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.application.operation.sync.Resources> getResources() {
        return resources;
    }

    public void setResources(java.util.List<io.quarkiverse.argocd.v1alpha1.application.operation.sync.Resources> resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.application.operation.sync.Source source;

    public io.quarkiverse.argocd.v1alpha1.application.operation.sync.Source getSource() {
        return source;
    }

    public void setSource(io.quarkiverse.argocd.v1alpha1.application.operation.sync.Source source) {
        this.source = source;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.application.operation.sync.Sources> sources;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.application.operation.sync.Sources> getSources() {
        return sources;
    }

    public void setSources(java.util.List<io.quarkiverse.argocd.v1alpha1.application.operation.sync.Sources> sources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.application.operation.sync.SyncStrategy syncStrategy;

    public io.quarkiverse.argocd.v1alpha1.application.operation.sync.SyncStrategy getSyncStrategy() {
        return syncStrategy;
    }

    public void setSyncStrategy(io.quarkiverse.argocd.v1alpha1.application.operation.sync.SyncStrategy syncStrategy) {
