...
public class Retry implements io.fabric8.kubernetes.api.builder.Editable<RetryBuilder>,
    ...
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.retry.Backoff backoff;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.retry.Backoff getBackoff() {
        return backoff;
    }

    public void setBackoff(io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.retry.Backoff backoff) {
