...
public class Directory implements io.fabric8.kubernetes.api.builder.Editable<DirectoryBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.application.operation.sync.source.directory.Jsonnet jsonnet;

    public io.quarkiverse.argocd.v1alpha1.application.operation.sync.source.directory.Jsonnet getJsonnet() {
        return jsonnet;
    }

    public void setJsonnet(io.quarkiverse.argocd.v1alpha1.application.operation.sync.source.directory.Jsonnet jsonnet) {
