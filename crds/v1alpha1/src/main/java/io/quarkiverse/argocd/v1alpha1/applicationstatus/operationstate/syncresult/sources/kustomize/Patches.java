...
public class Patches implements io.fabric8.kubernetes.api.builder.Editable<PatchesBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.syncresult.sources.kustomize.patches.Target target;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.syncresult.sources.kustomize.patches.Target getTarget() {
        return target;
    }

    public void setTarget(
            io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.syncresult.sources.kustomize.patches.Target target) {
        this.target = target;
    }
}
