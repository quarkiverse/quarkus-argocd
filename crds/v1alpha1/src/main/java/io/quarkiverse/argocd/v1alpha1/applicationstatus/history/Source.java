...
public class Source implements io.fabric8.kubernetes.api.builder.Editable<SourceBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Directory directory;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Directory getDirectory() {
        return directory;
    }

    public void setDirectory(io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Directory directory) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Helm helm;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Helm getHelm() {
        return helm;
    }

    public void setHelm(io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Helm helm) {
        this.helm = helm;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Kustomize kustomize;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Kustomize getKustomize() {
        return kustomize;
    }

    public void setKustomize(io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Kustomize kustomize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Plugin plugin;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Plugin getPlugin() {
        return plugin;
    }

    public void setPlugin(io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.Plugin plugin) {
        this.plugin = plugin;
    }
