...
public class SyncStrategy implements io.fabric8.kubernetes.api.builder.Editable<SyncStrategyBuilder>,
    ...
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.syncstrategy.Apply apply;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.syncstrategy.Apply getApply() {
        return apply;
    }

    public void setApply(
            io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.syncstrategy.Apply apply) {
        this.apply = apply;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.syncstrategy.Hook hook;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.syncstrategy.Hook getHook() {
        return hook;
    }

    public void setHook(io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.syncstrategy.Hook hook) {
        this.hook = hook;
    }
}
