package io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources;

@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "fileParameters", "ignoreMissingValueFiles", "parameters",
        "passCredentials", "releaseName", "skipCrds", "valueFiles", "values", "valuesObject", "version" })
...
public class Helm
        implements io.fabric8.kubernetes.api.builder.Editable<HelmBuilder>, io.fabric8.kubernetes.api.model.KubernetesResource {

    @java.lang.Override
    public HelmBuilder edit() {
    ...
    private java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.FileParameters> fileParameters;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.FileParameters> getFileParameters() {
        return fileParameters;
    }

    public void setFileParameters(
            java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.FileParameters> fileParameters) {
        this.fileParameters = fileParameters;
    }

    /**
     * IgnoreMissingValueFiles prevents helm template from failing when valueFiles do not exist locally by not appending them to
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.Parameters> parameters;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.Parameters> getParameters() {
        return parameters;
    }

    public void setParameters(
            java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.Parameters> parameters) {
    ...
    /**
     * Values specifies Helm values to be passed to helm template, typically defined as a block. ValuesObject takes precedence
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.ValuesObject valuesObject;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.ValuesObject getValuesObject() {
        return valuesObject;
    }

    public void setValuesObject(
            io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.helm.ValuesObject valuesObject) {
