...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "dryRun", "manifests", "prune", "resources", "revision", "revisions",
        "source", "sources", "syncOptions", "syncStrategy" })
...
public class Sync
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Resources> resources;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Resources> getResources() {
        return resources;
    }

    public void setResources(
            java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Resources> resources) {
        this.resources = resources;
    }

    /**
     * Revision is the revision (Git) or chart version (Helm) which to sync the application to If omitted, will use the revision
    ...
    /**
     * Revisions is the list of revision (Git) or chart version (Helm) which to sync each source in sources field for the
     * application to If omitted, will use the revision specified in app spec.
     */
    ...
    /**
     * Source overrides the source definition set in the application. This is typically set in a Rollback operation and is nil
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Source source;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Source getSource() {
        return source;
    }

    public void setSource(io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Source source) {
        this.source = source;
    }

    /**
     * Sources overrides the source definition set in the application. This is typically set in a Rollback operation and is nil
     * during a Sync operation
     */
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Sources> sources;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Sources> getSources() {
        return sources;
    }

    public void setSources(
            java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.Sources> sources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.SyncStrategy syncStrategy;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.SyncStrategy getSyncStrategy() {
        return syncStrategy;
    }

    public void setSyncStrategy(
            io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.SyncStrategy syncStrategy) {
