...
public class Helm
    ...
    private java.util.List<io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.FileParameters> fileParameters;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.FileParameters> getFileParameters() {
        return fileParameters;
    }

    public void setFileParameters(
            java.util.List<io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.FileParameters> fileParameters) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.Parameters> parameters;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.Parameters> getParameters() {
        return parameters;
    }

    public void setParameters(
            java.util.List<io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.Parameters> parameters) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.ValuesObject valuesObject;

    public io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.ValuesObject getValuesObject() {
        return valuesObject;
    }

    public void setValuesObject(io.quarkiverse.argocd.v1alpha1.applicationspec.sources.helm.ValuesObject valuesObject) {
