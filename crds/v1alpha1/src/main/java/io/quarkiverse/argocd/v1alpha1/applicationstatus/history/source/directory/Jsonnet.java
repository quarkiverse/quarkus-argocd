package io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.directory;
...
public class Jsonnet implements io.fabric8.kubernetes.api.builder.Editable<JsonnetBuilder>,
    ...
    private java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.directory.jsonnet.ExtVars> extVars;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.directory.jsonnet.ExtVars> getExtVars() {
        return extVars;
    }

    public void setExtVars(
            java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.directory.jsonnet.ExtVars> extVars) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.directory.jsonnet.Tlas> tlas;

    public java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.directory.jsonnet.Tlas> getTlas() {
        return tlas;
    }

    public void setTlas(
            java.util.List<io.quarkiverse.argocd.v1alpha1.applicationstatus.history.source.directory.jsonnet.Tlas> tlas) {
        this.tlas = tlas;
    }
}
