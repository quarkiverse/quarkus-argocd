...
public class Sources implements io.fabric8.kubernetes.api.builder.Editable<SourcesBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Directory directory;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Directory getDirectory() {
        return directory;
    }

    public void setDirectory(
            io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Directory directory) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Helm helm;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Helm getHelm() {
        return helm;
    }

    public void setHelm(io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Helm helm) {
        this.helm = helm;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Kustomize kustomize;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Kustomize getKustomize() {
        return kustomize;
    }

    public void setKustomize(
            io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Kustomize kustomize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Plugin plugin;

    public io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Plugin getPlugin() {
        return plugin;
    }

    public void setPlugin(
            io.quarkiverse.argocd.v1alpha1.applicationstatus.operationstate.operation.sync.sources.Plugin plugin) {
        this.plugin = plugin;
    }
