...
public class AwsElasticBlockStore implements io.fabric8.kubernetes.api.builder.Editable<AwsElasticBlockStoreBuilder>,
        io.fabric8.kubernetes.api.model.KubernetesResource {

    @java.lang.Override
    public AwsElasticBlockStoreBuilder edit() {
        return new AwsElasticBlockStoreBuilder(this);
    }
     ...
     * https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore TODO: how do we prevent errors in the filesystem
