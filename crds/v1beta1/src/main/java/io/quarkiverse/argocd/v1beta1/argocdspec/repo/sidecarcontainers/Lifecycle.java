...
public class Lifecycle implements io.fabric8.kubernetes.api.builder.Editable<LifecycleBuilder>,
    ...
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.PostStart postStart;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.PostStart getPostStart() {
        return postStart;
    }

    public void setPostStart(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.PostStart postStart) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.PreStop preStop;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.PreStop getPreStop() {
        return preStop;
    }

    public void setPreStop(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.PreStop preStop) {
