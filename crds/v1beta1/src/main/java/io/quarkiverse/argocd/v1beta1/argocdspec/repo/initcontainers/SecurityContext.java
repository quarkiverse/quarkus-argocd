...
public class SecurityContext implements io.fabric8.kubernetes.api.builder.Editable<SecurityContextBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.Capabilities capabilities;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.Capabilities getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.Capabilities capabilities) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.SeLinuxOptions seLinuxOptions;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.SeccompProfile seccompProfile;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.WindowsOptions windowsOptions;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.securitycontext.WindowsOptions windowsOptions) {
