...
public class ReadinessProbe implements io.fabric8.kubernetes.api.builder.Editable<ReadinessProbeBuilder>,
    ...
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.Exec exec;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.Grpc grpc;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.HttpGet httpGet;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.TcpSocket tcpSocket;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.readinessprobe.TcpSocket tcpSocket) {
