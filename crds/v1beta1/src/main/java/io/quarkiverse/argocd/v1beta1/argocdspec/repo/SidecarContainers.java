...
public class SidecarContainers implements io.fabric8.kubernetes.api.builder.Editable<SidecarContainersBuilder>,
        io.fabric8.kubernetes.api.model.KubernetesResource {

    @java.lang.Override
    public SidecarContainersBuilder edit() {
        return new SidecarContainersBuilder(this);
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Env> env;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Env> getEnv() {
        return env;
    }

    public void setEnv(java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Env> env) {
        this.env = env;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.EnvFrom> envFrom;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.EnvFrom> getEnvFrom() {
        return envFrom;
    }

    public void setEnvFrom(java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.EnvFrom> envFrom) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Lifecycle lifecycle;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Lifecycle getLifecycle() {
        return lifecycle;
    }

    public void setLifecycle(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Lifecycle lifecycle) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.LivenessProbe livenessProbe;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.LivenessProbe getLivenessProbe() {
        return livenessProbe;
    }

    public void setLivenessProbe(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.LivenessProbe livenessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Ports> ports;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Ports> getPorts() {
        return ports;
    }

    public void setPorts(java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Ports> ports) {
        this.ports = ports;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.ReadinessProbe readinessProbe;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.ReadinessProbe getReadinessProbe() {
        return readinessProbe;
    }

    public void setReadinessProbe(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.ReadinessProbe readinessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.ResizePolicy> resizePolicy;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.ResizePolicy> getResizePolicy() {
        return resizePolicy;
    }

    public void setResizePolicy(
            java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.ResizePolicy> resizePolicy) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Resources resources;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Resources getResources() {
        return resources;
    }

    public void setResources(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.SecurityContext securityContext;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.SecurityContext getSecurityContext() {
        return securityContext;
    }

    public void setSecurityContext(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.SecurityContext securityContext) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.StartupProbe startupProbe;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.StartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.StartupProbe startupProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.VolumeDevices> volumeDevices;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.VolumeDevices> getVolumeDevices() {
        return volumeDevices;
    }

    public void setVolumeDevices(
            java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.VolumeDevices> volumeDevices) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.VolumeMounts> volumeMounts;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.VolumeMounts> getVolumeMounts() {
        return volumeMounts;
    }

    public void setVolumeMounts(
            java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.VolumeMounts> volumeMounts) {
