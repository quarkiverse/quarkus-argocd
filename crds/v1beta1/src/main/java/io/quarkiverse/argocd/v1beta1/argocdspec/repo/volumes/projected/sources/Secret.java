...
public class Secret implements io.fabric8.kubernetes.api.builder.Editable<SecretBuilder>,
    ...
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.secret.Items> items;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.secret.Items> getItems() {
        return items;
    }

    public void setItems(
            java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.secret.Items> items) {
        this.items = items;
    }
