package io.quarkiverse.argocd.v1beta1.argocdspec.redis;
...
public class Resources implements io.fabric8.kubernetes.api.builder.Editable<ResourcesBuilder>,
    ...
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.redis.resources.Claims> claims;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.redis.resources.Claims> getClaims() {
        return claims;
    }

    public void setClaims(java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.redis.resources.Claims> claims) {
        this.claims = claims;
    }
