...
public class GcePersistentDisk implements io.fabric8.kubernetes.api.builder.Editable<GcePersistentDiskBuilder>,
        io.fabric8.kubernetes.api.model.KubernetesResource {

    @java.lang.Override
    public GcePersistentDiskBuilder edit() {
        return new GcePersistentDiskBuilder(this);
    }
     ...
     * https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk TODO: how do we prevent errors in the filesystem
     ...
     * Examples: For volume /dev/sda1, you specify the partition as "1". Similarly, the volume partition for /dev/sda is "0" (or
     * you can leave the property empty). More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk
     */
