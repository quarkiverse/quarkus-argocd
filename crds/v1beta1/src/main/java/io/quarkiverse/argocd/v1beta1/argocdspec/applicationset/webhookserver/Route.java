...
public class Route implements io.fabric8.kubernetes.api.builder.Editable<RouteBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.applicationset.webhookserver.route.Tls tls;

    public io.quarkiverse.argocd.v1beta1.argocdspec.applicationset.webhookserver.route.Tls getTls() {
        return tls;
    }

    public void setTls(io.quarkiverse.argocd.v1beta1.argocdspec.applicationset.webhookserver.route.Tls tls) {
        this.tls = tls;
    }
