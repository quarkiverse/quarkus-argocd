...
public class StartupProbe implements io.fabric8.kubernetes.api.builder.Editable<StartupProbeBuilder>,
    ...
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.Exec exec;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.Exec getExec() {
        return exec;
    }

    public void setExec(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.Grpc grpc;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.HttpGet httpGet;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.TcpSocket tcpSocket;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.startupprobe.TcpSocket tcpSocket) {
