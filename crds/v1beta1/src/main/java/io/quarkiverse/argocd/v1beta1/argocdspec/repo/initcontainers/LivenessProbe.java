...
public class LivenessProbe implements io.fabric8.kubernetes.api.builder.Editable<LivenessProbeBuilder>,
    ...
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.Exec exec;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.Grpc grpc;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.HttpGet httpGet;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.TcpSocket tcpSocket;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.livenessprobe.TcpSocket tcpSocket) {
