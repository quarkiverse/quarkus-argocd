...
public class Fc
        implements io.fabric8.kubernetes.api.builder.Editable<FcBuilder>, io.fabric8.kubernetes.api.model.KubernetesResource {

    @java.lang.Override
    public FcBuilder edit() {
     ...
     * "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified. TODO: how do we prevent errors in the filesystem from
