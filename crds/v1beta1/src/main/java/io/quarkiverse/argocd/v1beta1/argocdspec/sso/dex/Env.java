...
public class Env
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.sso.dex.env.ValueFrom valueFrom;

    public io.quarkiverse.argocd.v1beta1.argocdspec.sso.dex.env.ValueFrom getValueFrom() {
        return valueFrom;
    }

    public void setValueFrom(io.quarkiverse.argocd.v1beta1.argocdspec.sso.dex.env.ValueFrom valueFrom) {
