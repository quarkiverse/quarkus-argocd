...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "fsType", "image", "keyring", "monitors", "pool", "readOnly", "secretRef",
        "user" })
...
public class Rbd
        implements io.fabric8.kubernetes.api.builder.Editable<RbdBuilder>, io.fabric8.kubernetes.api.model.KubernetesResource {

    @java.lang.Override
    public RbdBuilder edit() {
     ...
     * https://kubernetes.io/docs/concepts/storage/volumes#rbd TODO: how do we prevent errors in the filesystem from
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.rbd.SecretRef secretRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.rbd.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.rbd.SecretRef secretRef) {
