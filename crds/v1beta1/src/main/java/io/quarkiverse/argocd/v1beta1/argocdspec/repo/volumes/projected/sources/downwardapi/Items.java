package io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.downwardapi;
...
public class Items implements io.fabric8.kubernetes.api.builder.Editable<ItemsBuilder>,
    ...
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.downwardapi.items.FieldRef fieldRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.downwardapi.items.FieldRef getFieldRef() {
        return fieldRef;
    }

    public void setFieldRef(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.downwardapi.items.FieldRef fieldRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.downwardapi.items.ResourceFieldRef resourceFieldRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.downwardapi.items.ResourceFieldRef getResourceFieldRef() {
        return resourceFieldRef;
    }

    public void setResourceFieldRef(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.projected.sources.downwardapi.items.ResourceFieldRef resourceFieldRef) {
