...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "allowPrivilegeEscalation", "capabilities", "privileged", "procMount",
        "readOnlyRootFilesystem", "runAsGroup", "runAsNonRoot", "runAsUser", "seLinuxOptions", "seccompProfile",
        "windowsOptions" })
...
public class SecurityContext implements io.fabric8.kubernetes.api.builder.Editable<SecurityContextBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.Capabilities capabilities;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.Capabilities getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.Capabilities capabilities) {
     ...
     * context for each container. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext,
     * the value specified in SecurityContext takes precedence. Note that this field cannot be set when spec.os.name is windows.
     */
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.SeLinuxOptions seLinuxOptions;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.SeccompProfile seccompProfile;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.WindowsOptions windowsOptions;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.securitycontext.WindowsOptions windowsOptions) {
