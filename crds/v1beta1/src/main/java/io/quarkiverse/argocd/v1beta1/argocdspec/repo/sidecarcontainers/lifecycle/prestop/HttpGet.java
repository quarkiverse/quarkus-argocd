package io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.prestop;
...
public class HttpGet implements io.fabric8.kubernetes.api.builder.Editable<HttpGetBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.prestop.httpget.HttpHeaders> httpHeaders;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.prestop.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(
            java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.prestop.httpget.HttpHeaders> httpHeaders) {
