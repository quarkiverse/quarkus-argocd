...
public class Ingress implements io.fabric8.kubernetes.api.builder.Editable<IngressBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.prometheus.ingress.Tls> tls;

    public java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.prometheus.ingress.Tls> getTls() {
        return tls;
    }

    public void setTls(java.util.List<io.quarkiverse.argocd.v1beta1.argocdspec.prometheus.ingress.Tls> tls) {
        this.tls = tls;
    }
}
