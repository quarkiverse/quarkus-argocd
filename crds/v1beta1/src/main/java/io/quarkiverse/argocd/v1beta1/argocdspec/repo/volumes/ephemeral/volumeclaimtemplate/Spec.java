package io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate;
...
public class Spec
        implements io.fabric8.kubernetes.api.builder.Editable<SpecBuilder>, io.fabric8.kubernetes.api.model.KubernetesResource {
     ...
     * controller can support the specified data source, it will create a new volume based on the contents of the specified data
     * source. When the AnyVolumeDataSource feature gate is enabled, dataSource contents will be copied to dataSourceRef, and
     * dataSourceRef contents will be copied to dataSource when dataSourceRef.namespace is not specified. If the namespace is
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.DataSource dataSource;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef dataSourceRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.DataSourceRef dataSourceRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.Resources resources;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.Resources getResources() {
        return resources;
    }

    public void setResources(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.Selector selector;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.Selector getSelector() {
        return selector;
    }

    public void setSelector(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.ephemeral.volumeclaimtemplate.spec.Selector selector) {
