package io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env;
...
public class ValueFrom implements io.fabric8.kubernetes.api.builder.Editable<ValueFromBuilder>,
    ...
    private io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.ConfigMapKeyRef configMapKeyRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.ConfigMapKeyRef getConfigMapKeyRef() {
        return configMapKeyRef;
    }

    public void setConfigMapKeyRef(
            io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.ConfigMapKeyRef configMapKeyRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.FieldRef fieldRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.FieldRef getFieldRef() {
        return fieldRef;
    }

    public void setFieldRef(io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.FieldRef fieldRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.ResourceFieldRef resourceFieldRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.ResourceFieldRef getResourceFieldRef() {
        return resourceFieldRef;
    }

    public void setResourceFieldRef(
            io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.ResourceFieldRef resourceFieldRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.SecretKeyRef secretKeyRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.SecretKeyRef getSecretKeyRef() {
        return secretKeyRef;
    }

    public void setSecretKeyRef(
            io.quarkiverse.argocd.v1beta1.argocdspec.notifications.env.valuefrom.SecretKeyRef secretKeyRef) {
