...
public class PreStop implements io.fabric8.kubernetes.api.builder.Editable<PreStopBuilder>,
    ...
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.Exec exec;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.Exec getExec() {
        return exec;
    }

    public void setExec(io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.HttpGet httpGet;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.TcpSocket tcpSocket;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.initcontainers.lifecycle.prestop.TcpSocket tcpSocket) {
