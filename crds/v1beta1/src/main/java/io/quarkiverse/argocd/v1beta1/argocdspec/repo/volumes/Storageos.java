...
public class Storageos implements io.fabric8.kubernetes.api.builder.Editable<StorageosBuilder>,
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.storageos.SecretRef secretRef;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.storageos.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(io.quarkiverse.argocd.v1beta1.argocdspec.repo.volumes.storageos.SecretRef secretRef) {
    ...
    /**
     * volumeNamespace specifies the scope of the volume within StorageOS. If no namespace is specified then the Pod's namespace
     * will be used. This allows the Kubernetes name scoping to be mirrored within StorageOS for tighter integration. Set
     * VolumeName to any name to override the default behaviour. Set to "default" if you are not using namespaces within
