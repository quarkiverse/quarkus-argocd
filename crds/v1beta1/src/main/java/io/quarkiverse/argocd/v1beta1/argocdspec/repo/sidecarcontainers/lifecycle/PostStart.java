...
public class PostStart implements io.fabric8.kubernetes.api.builder.Editable<PostStartBuilder>,
    ...
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.Exec exec;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.Exec getExec() {
        return exec;
    }

    public void setExec(io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.HttpGet httpGet;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.TcpSocket tcpSocket;

    public io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(
            io.quarkiverse.argocd.v1beta1.argocdspec.repo.sidecarcontainers.lifecycle.poststart.TcpSocket tcpSocket) {
